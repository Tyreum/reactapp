      ...
      <>
        ...
        <div class="ui grid three column container">
          ...
          {this.state.lista.map(projeto => {
            ...
            <div class="column">
              <div class="ui card">
                <div class="image"><img src="https://img.buzzfeed.com/buzzfeed-static/static/
                2018-04/12/12/asset/buzzfeed-prod-web-05/sub-buzz-17953-1523550200-3.jpg
                ?downsize=700%3A%2A&output-quality=auto&output-format=auto&output-quality=auto
                &output-format=auto&downsize=360:*" /></div>
                <div class="content">
